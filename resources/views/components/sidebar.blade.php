<aside class="flex w-1/5 bg-slate-800 text-slate-200">
    <div class="w-full mx-3 mt-2">
        ...
        <nav class="flex flex-col gap-2 mt-2">
            <a class="hover:bg-slate-600 px-2 py-1 rounded transition" href="">Tasks</a>
            ...
            <a class="hover:bg-slate-600 px-2 py-1 rounded transition"  href="{{ route("admin.links")}}">Links</a>
        </nav>
    </div>
</aside>
